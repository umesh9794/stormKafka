...
public enum ComponentFailureEnum {
    ...
    KAFKA_DEMO_PUBLISHER_BOLT(ColumnFamilyEnum.KAFKA_FAILED_FAM.getColumnFamilyName(),"kafka_bolt_retry_stream"),
    KAFKA_DEMO_CONSUMER_BOLT(ColumnFamilyEnum.KAFKA_CONSUMER_FAILED_FAM.getColumnFamilyName(),"kafka_consumer_bolt_retry_stream"),
    ...
    public static ComponentFailureEnum fromCFName(String cfName) {
        ...
        else if (ColumnFamilyEnum.KAFKA_CONSUMER_FAILED_FAM.getColumnFamilyName().equalsIgnoreCase(cfName)) {
            componentFailureEnum = ComponentFailureEnum.KAFKA_DEMO_CONSUMER_BOLT;
        }
        else if (ColumnFamilyEnum.KAFKA_PUBLISHER_FAILED_FAM.getColumnFamilyName().equalsIgnoreCase(cfName)) {
            componentFailureEnum = ComponentFailureEnum.KAFKA_DEMO_PUBLISHER_BOLT;
        }
...
enum ColumnFamilyEnum {
    ...
    KAFKA_CONSUMER_FAILED_FAM("kafka_consumer_failed_fam"),
    KAFKA_PUBLISHER_FAILED_FAM("kafka_consumer_failed_fam"),
